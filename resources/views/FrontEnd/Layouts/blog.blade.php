                    ...
                    <div class="row">
                        ...
                        @foreach($posts as $Post)
                            <div class="post col-xl-6">
                                <div class="post-thumbnail"><a href="{{route('singlePost', $Post->slug)}}"><img
                                                src="{{$Post->img_url}}" alt="..." class="img-fluid"></a></div>
                                <div class="post-details">
                                    ...
                                    <footer class="post-footer d-flex align-items-center"><a href="#"
                                            ...
                                            <div class="avatar"><img src="{{asset('assets')}}/img/avatar-1.jpg"
                                                                     alt="..." class="img-fluid"></div>
                                            <div class="title">
                                                <span>{{substr(strip_tags($Post->user->name), 0, 10)}}</span></div>
                                        </a>
                                        <div class="date"><i
                                                    class="icon-clock"></i> {{Carbon\Carbon::parse($Post->updated_at)->diffForHumans()}}
                                        </div>
